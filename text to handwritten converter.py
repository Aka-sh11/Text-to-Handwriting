...
im1 = PIL.Image.open('writing.png')
...
conv = Button(conv_border, text='Convert Text', command=threading, bg='black', fg="#00FF89",
              font=('times', 15, ' bold '), activebackground="#00FF89")
conv.pack(padx=1, pady=1)
conv_border.place(x=30, y=650)

clear_border = Frame(windo, borderwidth=2, background="#8B13F3")
clear = Button(clear_border, text='Clear Text', command=clear_txt, bg='black', fg="#00FF89",
               font=('times', 15, ' bold '), activebackground="#00FF89")
clear.pack(padx=1, pady=1)
clear_border.place(x=255, y=650)

color_border = Frame(windo, borderwidth=2, background="#8B13F3")
color = Button(color_border, text='Choose Color', command=color_choose, bg='black', fg="#00FF89",
               font=('times', 15, ' bold '), activebackground="#00FF89")
